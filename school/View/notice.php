...
<?php }else{
  ...
  <?php
    ...
    <div class="container-fluid">
      <div class="row" style="justify-content: center;color: white; background-color: #1a237e;"><h5>Notice</h5></div>
      <?php 
...
$start_from = ($page-1) * $limit; 
                      ...
                      $sql="select *from notice WHERE school=1 ORDER BY id DESC LIMIT $start_from, $limit ";
