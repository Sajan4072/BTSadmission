            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                <div class="container uploadsection">
                  ...
                  ?>
                    ...
                    <p style="display: inline-flex;">
                        <a href="collage_teacher_registration.php" class="btn btn-primary" style="background-color: #224a8f; border: none; border-radius: 20px; margin-bottom: 5px; margin-left: 250px">register</a>
                    </p>
                    <div class="col-12">
