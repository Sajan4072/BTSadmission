...
if(isset($_GET['type']))
{
  $id=$_GET['id'];
  $edit='set';
  $sql="select * from engineering_teacher where id='$id' limit 1 ";
...
?>  
  <div class="container">
        <div class="row formtitle">
            <h5>Engineering TEACHER REGISTRATION FORM</h5>
        </div>
...
<div class="form-row">
   ...
   <?php if(isset($edit)){
    ...
    value="<?php if(isset($_SESSION['contact'])){echo $_SESSION['contact']; unset($_SESSION['contact']); } else if(isset($edit)){ echo $teacher['contact'];  } ?>"
    >  
   ...
   value="<?php if(isset($_SESSION['password'])){echo $_SESSION['password']; unset($_SESSION['password']); }else if(isset($edit)){ echo $teacher['password'];  } ?>"
    ...
    <div class="form-group col-md-12" style="text-align: center;"> 
     ...
     <?php if(isset($edit)){?>
   <input type="submit" name="engineering_teacher_edit" value="update" class="btn btn-primary" style="background-color: #224a8f; border: none;">
     <?php } else {?>
         <input type="submit" name="engineering_teacher_insert" value="REGISTER" class="btn btn-primary" style="background-color: #224a8f; border: none;">
  ...
  <div class="col-lg-5 col-md-12 col-sm-12 textcol" style="background-color: #224a8f; opacity: 60%; padding-top: 100px; text-align: center; color: white;">
                ...
                <br>
                <a href="engineering_teacher_registration_table.php" class="btn-primary btn btn-sm">Click to go previous page</a>
            </div>
