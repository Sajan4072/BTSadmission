...
if(isset($_GET['type']))
{
  $id=$_GET['id'];
  $edit='set';
  $sql="select * from engineering where uniquecode='$id' limit 1 ";
...
?>  
  <div class="container">
        ...
        <div class="row formtitle">
            <h5>ENGINEERING STUDENT REGISTRATION FORM</h5>
        </div>
...
<?php
    ...
    <input type="text" name="fname"  class="form-control" id="inputName" required placeholder="First Name" autocomplete="off" value="<?php
      if(isset($edit))
      {
...
<div class="form-row">
   ...
   if(isset($_SESSION['uniquecode'])){ echo $_SESSION['uniquecode']; unset($_SESSION['uniquecode']);}?>" 
    ...
    {
    ?>                     
    <input type="submit" name="engineering_stu_registration" value="REGISTER" class="btn btn-primary" style="background-color: #224a8f; border: none;">  
    <?php }  else {?>
    <input type="submit" name="engineering_stu_registration_edit" value="update" class="btn btn-primary" style="background-color: #224a8f; border: none;">  
  ...
  <div class="col-lg-5 col-md-12 col-sm-12 textcol" style="background-color: black;  text-align: center; color: white;">
                ...
                <br>
                <a href="engineering_student_registration_table.php" class="btn-primary btn btn-sm">Click to go previous page</a>
                <br>
                <?php if(!isset($edit)) {?>
