  ...
  <?php
                ...
                <?php 
                    ...
                    $show_drop_down=true;
                     ...
                     include "../include/connection.php";
                      ...
                      $sql1="select distinct class from collegeresult where uniquecode='$code'";
   ...
   color: white;
    ...
    <?php
      ...
      <div class="area-to-print">
    <div class="container-fluid">
      <h4 style=" color: blue; font-size: 60px; margin-bottom: 150px; text-align: center;">Please Pay College Fee</h4>
