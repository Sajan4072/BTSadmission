...
<div class="row" style="background-color: green; height: 40px; color: white; justify-content: center;">
 <h4>HERE ARE SOME RESOURCES OF LAW FACULTY</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 LAW</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="law/english12.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(004)</button></a>         
<a href="law/criminallaw12.php" style="color: black; text-decoration: none;"><button class="button button2">Criminal Law <br> & Justice(674)</button></a>
<a href="law/legaldrafting12.php" style="color: black; text-decoration: none;"><button class="button button1">Legal Drafting<br>(668)</button></a>
<a href="law/civillaw12.php" style="color: black; text-decoration: none;"><button class="button button2">Civil Law and <br>Justice (672)</button></a>
<a href="law/procedurallaw12.php" style="color: black; text-decoration: none;"><button class="button button1">Procedural Law<br>(670)</button></a>
<a href="law/humanright12.php" style="color: black; text-decoration: none;"><button class="button button2">Human Rights<br>(676)</button></a>
...
$start_from = ($page-1) * $limit;            
                      $sql="select *from college_resource where law = 1 and class = 12  ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
   <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='class12law.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='class12law.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
     <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='class12law.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
