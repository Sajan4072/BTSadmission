...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 MANAGEMENT</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="management/english12.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(004)</button></a>         
<a href="management/account12.php" style="color: black; text-decoration: none;"><button class="button button2">Accounting <br>(224)</button></a>
<a href="management/hotel12.php" style="color: black; text-decoration: none;"><button class="button button1">Hotel Management<br>(270)</button></a>
<a href="management/economic12.php" style="color: black; text-decoration: none;"><button class="button button2">Economics<br>(226)</button></a>
<a href="management/business12.php" style="color: black; text-decoration: none;"><button class="button button1">Business Studies<br>(628)</button></a>
<a href="management/bmath12.php" style="color: black; text-decoration: none;"><button class="button button2">Business Matematics<br>(908)</button></a>
<a href="management/marketing12.php" style="color: black; text-decoration: none;"><button class="button button1" >Marketing<br>(910)</button></a>
</div>
...
$start_from = ($page-1) * $limit;            
                      $sql="select *from college_resource where management = 1 and class = 12  ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='class12mng.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='class11mng.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='class12mng.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
