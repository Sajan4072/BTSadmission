...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 11 MANAGEMENT</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="management/english11.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(002)</button></a>         
<a href="management/nepali11.php" style="color: black; text-decoration: none;"><button class="button button2">C.Nepali<br>(003)</button></a>
<a href="management/account11.php" style="color: black; text-decoration: none;"><button class="button button1">Accounting<br>(124)</button></a>
<a href="management/economic11.php" style="color: black; text-decoration: none;"><button class="button button2">Economics<br>(126)</button></a>
<a href="management/business11.php" style="color: black; text-decoration: none;"><button class="button button1">Business Studies<br>(328)</button></a>
<a href="management/hotel11.php" style="color: black; text-decoration: none;"><button class="button button2">Hotel Management<br>(170)</button></a>
</div>
...
$start_from = ($page-1) * $limit;            
                      $sql="select *from college_resource where management = 1 and class = 11  ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='class11mng.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='class11mng.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
