...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 EDUCATION</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="education/english12.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(004)</button></a>         
<a href="education/nepali12.php" style="color: black; text-decoration: none;"><button class="button button2">Optional Nepali<br>(232)</button></a>
<a href="education/optenglish12.php" style="color: black; text-decoration: none;"><button class="button button1">Optional English <br>(220)</button></a>
<a href="education/healtheducation12.php" style="color: black; text-decoration: none;"><button class="button button2">Health and Physical <br>Education(244)</button></a>
<a href="education/population12.php" style="color: black; text-decoration: none;"><button class="button button1">Population<br>Studies(246)</button></a>
<a href="education/childrendev12.php" style="color: black; text-decoration: none;"><button class="button button2">Children Development <br>& Learning(902)</button></a>
<a href="education/evaluation12.php" style="color: black; text-decoration: none;"><button class="button button1">Instructional  <br>Evaluation(918)</button></a>
...
$start_from = ($page-1) * $limit;            
                      $sql="select *from college_resource where education = 1 and class = 12  ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='class12edu.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='class12edu.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
<li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='class12edu.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
