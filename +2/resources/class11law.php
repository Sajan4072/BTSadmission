...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 11 LAW</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="law/english11.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(002)</button></a>         
<a href="law/nepali11.php" style="color: black; text-decoration: none;"><button class="button button2">C.Nepali<br>(003)</button></a>
<a href="law/constitution11.php" style="color: black; text-decoration: none;"><button class="button button1">Constitutional Law & Nepali <br>Constitution(372)</button></a>
<a href="law/theoryoflaw11.php" style="color: black; text-decoration: none;"><button class="button button2">General Principle and <br>Theories of Law(126)</button></a>
<a href="law/legalsystem11.php" style="color: black; text-decoration: none;"><button class="button button1">Nepalese Legal<br>System(328)</button></a>
...
$start_from = ($page-1) * $limit;            
                      $sql="select *from college_resource where law = 1 and class = 11  ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
   <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='class11law.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='class11law.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
     <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='class11law.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
