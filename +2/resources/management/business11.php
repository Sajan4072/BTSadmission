...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 11 BUSINESS STUDIES</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="english11.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(002)</button></a>         
<a href="nepali11.php" style="color: black; text-decoration: none;"><button class="button button2">C.Nepali<br>(003)</button></a>
<a href="account11.php" style="color: black; text-decoration: none;"><button class="button button1" >Accounting<br>(124)</button></a>
<a href="economic11.php" style="color: black; text-decoration: none;"><button class="button button2">Economics<br>(126)</button></a>
<a href="business11.php" style="color: black; text-decoration: none;"><button class="button button1" style="background-color: #a3d8f7;" >Business Studies<br>(328)</button></a>
<a href="hotel11.php" style="color: black; text-decoration: none;"><button class="button button2">Hotel Management<br>(170)</button></a>
</div>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where management = 1 and class = 11 and subject = 'Business Studies' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where management = 1 and class = 11 and subject = 'Business Studies'";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='business11.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?> 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='business11.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='business11.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
