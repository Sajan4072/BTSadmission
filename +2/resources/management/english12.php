...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 ENGLISH</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="english12.php" style="color: black; text-decoration: none;"><button class="button button1" style="background-color: #a3d8f7;">C.English<br>(004)</button></a>         
<a href="account12.php" style="color: black; text-decoration: none;"><button class="button button2">Accounting <br>(224)</button></a>
<a href="hotel12.php" style="color: black; text-decoration: none;"><button class="button button1">Hotel Management<br>(270)</button></a>
<a href="economic12.php" style="color: black; text-decoration: none;"><button class="button button2">Economics<br>(226)</button></a>
<a href="business12.php" style="color: black; text-decoration: none;"><button class="button button1">Business Studies<br>(628)</button></a>
<a href="bmath12.php" style="color: black; text-decoration: none;"><button class="button button2">Business Matematics<br>(908)</button></a>
<a href="marketing12.php" style="color: black; text-decoration: none;"><button class="button button1" >Marketing<br>(910)</button></a>
</div>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where management = 1 and class = 12 and subject = 'C.English' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where management = 1 and class = 12 and subject = 'C.English'";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='english12.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?> 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='english12.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='english12.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
