...
<div class="row" style="background-color: green; height: 40px; color: white; justify-content: center;">
 <h4>WELCOME TO CLASS 11 EDUCATION</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 11 EDUCATION</h1>
      
  <div class="row" style="justify-content: center;">      

 <a href="education/english11.php" style="color: black; text-decoration: none;"><button class="button button1">C.English<br>(002)</button></a>         
<a href="education/nepali11.php" style="color: black; text-decoration: none;"><button class="button button2">C.Nepali<br>(003)</button></a>
<a href="education/optenglish11.php" style="color: black; text-decoration: none;"><button class="button button1">Optional English <br>(120)</button></a>
<a href="education/optnepali11.php" style="color: black; text-decoration: none;"><button class="button button2">Optional Nepali<br>(132)</button></a>
<a href="education/healtheducation11.php" style="color: black; text-decoration: none;"><button class="button button1">Health and Physical <br>Education(144)</button></a>
<a href="education/education11.php" style="color: black; text-decoration: none;"><button class="button button2">Introduction To<br>Education(134)</button></a>
<a href="education/pedagogy11.php" style="color: black; text-decoration: none;"><button class="button button1">Instructional  <br>Pedagogy(136)</button></a>
<a href="education/population11.php" style="color: black; text-decoration: none;"><button class="button button2">Population<br>Studies(146)</button></a>
...
$start_from = ($page-1) * $limit;            
                      $sql="select *from college_resource where education = 1 and class = 11  ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='class11edu.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='class11edu.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='class11edu.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
