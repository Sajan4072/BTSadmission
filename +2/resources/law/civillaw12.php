...
<div class="row" style="justify-content: center;">
 ...
 <h1 style="text-align: center; color: green;">WELCOE TO CLASS 12 CIVIL LAW AND JUSTICES</h1>
...
<a href="legaldrafting12.php" style="color: black; text-decoration: none;"><button class="button button1">Legal Drafting<br>(668)</button></a>
<a href="civillaw12.php" style="color: black; text-decoration: none;"><button class="button button2"style="background-color: #a8f7ad;">Civil Law and <br>Justice (672)</button></a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from college_resource where law = 1 and class = 12 and subject = 'civil law' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from college_resource where law = 1 and class = 12 and subject = 'civil law'";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='civillaw12.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?> 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='civillaw12.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?></li>
    <li class="page-item">
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='civillaw12.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
