...
<div class="container-fluid">
      <div class="row" style="justify-content: center;color: white; background-color: #1a237e;"><h5>Notices</h5></div>
      <?php 
...
$start_from = ($page-1) * $limit; 
                      ...
                      $sql="select *from notice WHERE engineering=1 ORDER BY id DESC LIMIT $start_from, $limit ";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='notice.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?> 
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='notice.php?page=".$i."' >".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='notice.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
