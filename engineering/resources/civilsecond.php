...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>WELCOME TO CIVIL ENGINEERING SECOND YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="civil/secondyear/mathematicsthird.php">Engineering Mathematics III</a>
    <a class="dropdown-item" href="civil/secondyear/surveyingfirst.php">Surveying I</a>
    <a class="dropdown-item" href="civil/secondyear/mechanics.php">Applied Mechanics</a>
  <a class="dropdown-item" href="civil/secondyear/hydrolics.php">basic Hydrolics</a>
  <a class="dropdown-item" href="civil/secondyear/building.php">Building Construction</a>
   <a class="dropdown-item" href="civil/secondyear/constructiondrawing.php">Construction Drawing</a>
    <a class="dropdown-item" href="civil/secondyear/computerdrawing.php">Computer Aided Drawing</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="civil/secondyear/socialstudies.php">Social Studies</a>
    <a class="dropdown-item" href="civil/secondyear/management.php">Management</a>
    <a class="dropdown-item" href="civil/secondyear/surveyingsecond.php">Surveying II</a>
  <a class="dropdown-item" href="civil/secondyear/costing.php">Estimating And Costing I</a>
  <a class="dropdown-item" href="civil/secondyear/structure.php">Mechanics of Structure</a>
  <a class="dropdown-item" href="civil/secondyear/soilmechanics.php">Soil Meachnics</a>
  <a class="dropdown-item" href="civil/secondyear/watersupply.php">Water Supply Engineering</a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='civil' and year='second' ORDER BY id ASC LIMIT $start_from, $limit";
...
?>
          ...
          <p style="text-align: center;"><?php echo "year: "; echo $row['year']; ?></p>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='civilsecond.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='civilsecond.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
