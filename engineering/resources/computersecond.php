...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>WELCOME TO COMPUTER ENGINEERING SECOND YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="computer/secondyear/webtechnology.php">Web Technology and Programming II</a>
    <a class="dropdown-item" href="computer/secondyear/mathematicsthird.php">Engineering Mathematics III</a>
    <a class="dropdown-item" href="computer/secondyear/datastructure.php"> Data Structure & Algorithm</a>
    <a class="dropdown-item" href="computer/secondyear/dbms.php">Database Management System(DBMS)</a>
    <a class="dropdown-item" href="computer/secondyear/microprocessor.php">Microprocessors</a>
    <a class="dropdown-item" href="computer/secondyear/electronic.php">Electronic Devices & Circuits </a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="computer/secondyear/datacommunication.php"> Data Communication</a>
    <a class="dropdown-item" href="computer/secondyear/systemanalysis.php">System Analysis and Design</a>
    <a class="dropdown-item" href="computer/secondyear/visualprogramming.php">Visual programming</a>
  <a class="dropdown-item" href="computer/secondyear/computerarchitecture.php">Computer Architecture</a>
  <a class="dropdown-item" href="computer/secondyear/computerrepair.php">Computer Repair & Maintenance</a>
  <a class="dropdown-item" href="computer/secondyear/computergraphics.php">Computer Graphics</a>
  <a class="dropdown-item" href="computer/secondyear/statistics.php">Statistics & Probability</a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty='computer' and year='second' ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='computersecond.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='computersecond.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='computersecond.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
