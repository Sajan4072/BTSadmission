...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>WELCOME TO COMPUTER ENGINEERING FIRST YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: center;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="civilfist.php">I Year</a>
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="computer/firstyear/communicationnepali.php">Communication Nepali</a>
    <a class="dropdown-item" href="computer/firstyear/communicationenglish.php">Communication English</a>
    <a class="dropdown-item" href="computer/firstyear/mathematicsfirst.php">Engineering Mathematics I</a>
    <a class="dropdown-item" href="computer/firstyear/physicsfirst.php">Engineering Physics I</a>
    <a class="dropdown-item" href="computer/firstyear/chemistryfirst.php">Engineering Chemistry I</a>
    <a class="dropdown-item" href="computer/firstyear/fundaments.php">Computer Fundaments</a>
  <a class="dropdown-item" href="computer/firstyear/engineeringdrawingfirst.php">Engineering Drawing I</a>
  <a class="dropdown-item" href="computer/firstyear/cprogramming.php">Computer Programming In C</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="computer/firstyear/mathematicssecond.php">Engineering Mathematics II</a>
    <a class="dropdown-item" href="computer/firstyear/physicssecond.php">Engineering Physics II</a>
    <a class="dropdown-item" href="computer/firstyear/chemistrysecond.php">Engineering Chemistry II</a>
  <a class="dropdown-item" href="computer/firstyear/digitallogic.php">Digital Logic</a>
  <a class="dropdown-item" href="computer/firstyear/objectoriented.php">Object Oriented Programming in C++</a>
  <a class="dropdown-item" href="computer/firstyear/electricalengineering.php">Electrical Engineering</a>
  <a class="dropdown-item" href="computer/firstyear/webtechnology.php">Web Technology & Programming I</a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty = 'computer' and year='first' ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='computerfirst.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='computerfirst.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='computerfirst.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
