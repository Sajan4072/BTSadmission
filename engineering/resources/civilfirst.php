...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>WELCOME TO CIVIL ENGINEERING FIRST YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="civil/firstyear/communicationnepali.php">Communication Nepali</a>
    <a class="dropdown-item" href="civil/firstyear/communicationenglish">Communication English</a>
    <a class="dropdown-item" href="civil/firstyear/mathematicfirst.php">Engineering Mathematics I</a>
    <a class="dropdown-item" href="civil/firstyear/physicsfirst.php">Engineering Physics I</a>
    <a class="dropdown-item" href="civil/firstyear/chemistryfirst.php">Engineering Chemistry I</a>
  <a class="dropdown-item" href="civil/firstyear/drawingfirst.php">Engineering Drawing I</a>
  <a class="dropdown-item" href="civil/firstyear/workshopfirst.php">Workshop Practice I</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="civil/firstyear/mathematicsecond.php">Engineering Mathematics II</a>
    <a class="dropdown-item" href="civil/firstyear/physicssecond.php">Engineering Physics II</a>
    <a class="dropdown-item" href="civil/firstyear/chemistrysecond.php">Engineering Chemistry II</a>
  <a class="dropdown-item" href="civil/firstyear/drawingsecond.php">Engineering Drawing II</a>
  <a class="dropdown-item" href="civil/firstyear/workshopsecond.php">Workshop Practice II</a>
  <a class="dropdown-item" href="civil/firstyear/materials.php">Engineering Materials</a>
  <a class="dropdown-item" href="civil/firstyear/computerapplication.php">Computer Application</a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='civil' and year='first' ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='civilfirst.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='civilfirst.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='civilfirst.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
