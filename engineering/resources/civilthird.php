...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>WELCOME TO CIVIL ENGINEERING THIRD YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="civil/thirdyear/surveyingsecond.php">Surveying II</a>
    <a class="dropdown-item" href="civil/thirdyear/costingsecond.php">Estimating And Costing II</a>
    <a class="dropdown-item" href="civil/thirdyear/structuraldesign.php">Structural Design and Drawing</a>
  <a class="dropdown-item" href="civil/thirdyear/highwayengineering.php">Highway Engineering I</a>
  <a class="dropdown-item" href="civil/thirdyear/sanitaryengineering.php">Sanitary Engineering</a>
   <a class="dropdown-item" href="civil/thirdyear/constructionmanagement.php">Construction Management</a>
    <a class="dropdown-item" href="civil/thirdyear/project.php">Minor Project(Survey Camp)</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="civil/thirdyear/enterprenurship.php">Enterprenurship Development</a>
    <a class="dropdown-item" href="civil/thirdyear/highwayengineeringsecond.php">Highway Engineering II</a>
    <a class="dropdown-item" href="civil/thirdyear/costingthird.php">Estimating And Costing III</a>
  <a class="dropdown-item" href="civil/thirdyear/drainage.php">Irrigation and Drainage Engineering</a>
  <a class="dropdown-item" href="civil/thirdyear/majorproject.php">Major Project</a>
  <hr>
  Elective
  <a class="dropdown-item" href="civil/thirdyear/trialbridge.php">Trial Bridge</a>
  <a class="dropdown-item" href="civil/thirdyear/hillroad.php">Hill Road</a>
  <a class="dropdown-item" href="civil/thirdyear/hillirrigation.php">Hill Irrigation Engineering</a>
  <a class="dropdown-item" href="civil/thirdyear/ruralroad.php">Rural/ Agricultural Road</a>
  <a class="dropdown-item" href="civil/thirdyear/gravity.php">Gravity Flow Water <br>Supply System</a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty='civil' and year ='third' ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='civilthird.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='civilthird.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='civilthird.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
