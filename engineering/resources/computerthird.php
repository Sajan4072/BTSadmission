...
<h5 style="text-align: center;">WELCOME TO COMPUTER ENGINEERING THIRD YEAR</h5>
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="computer/thirdyear/computernetworks.php">Computer Networks</a>
    <a class="dropdown-item" href="computer/thirdyear/mis.php">Management Information System (MIS)</a>
    <a class="dropdown-item" href="computer/thirdyear/telecommunication.php"> Applied Telecommunication</a>
    <a class="dropdown-item" href="computer/thirdyear/distributedcomputing.php">Distributed Computing</a>
    <a class="dropdown-item" href="computer/thirdyear/os.php">Operating System</a>
    <a class="dropdown-item" href="computer/thirdyear/cybersecurity.php">Cyber security and social ethic</a>
    <a class="dropdown-item" href="computer/thirdyear/minorproject.php"> Minor Project</a>
      <hr>
      Elective – I
      <a class="dropdown-item" href="computer/thirdyear/geographicalsystem.php"> Geographical Information System</a>
       <a class="dropdown-item" href="computer/thirdyear/simulation.php"> Computer Simulation and Modeling </a>
    <a class="dropdown-item" href="computer/thirdyear/java.php"> Java Programming</a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="computer/thirdyear/multimedia.php">  Multimedia Technology</a>
    <a class="dropdown-item" href="computer/thirdyear/internet.php">Internet Technology</a>
    <a class="dropdown-item" href="computer/thirdyear/datamining.php">Data Mining</a>
  <a class="dropdown-item" href="computer/thirdyear/software.php">Software Engineering</a>
  <a class="dropdown-item" href="computer/thirdyear/majorproject.php">Major Project</a>
  <hr>
  Elective – II
  <a class="dropdown-item" href="computer/thirdyear/egovernance.php">E- Governance</a>
  <a class="dropdown-item" href="computer/thirdyear/ecommerce.php">E-commerce</a> 
   <a class="dropdown-item" href="computer/thirdyear/embeddedsystem.php">Embedded System</a>
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty='computer' and year='third' ORDER BY id ASC LIMIT $start_from, $limit";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='computerthird.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='computerthird.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='computerthird.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
