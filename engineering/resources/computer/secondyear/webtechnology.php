...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>COMPUTER ENGINEERING SECOND YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<h5 style="text-align: center;">WELCOME TO WEB TECHNOLOGY AND PROGRAMMING II</h5>
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="webtechnology.php">Web Technology and Programming II</a>
    <a class="dropdown-item" href="mathematicsthird.php">Engineering Mathematics III</a>
    <a class="dropdown-item" href="datastructure.php"> Data Structure & Algorithm</a>
    <a class="dropdown-item" href="dbms.php">Database Management System(DBMS)</a>
    <a class="dropdown-item" href="microprocessor.php">Microprocessors</a>
    <a class="dropdown-item" href="electronic.php">Electronic Devices & Circuits </a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="datacommunication.php"> Data Communication</a>
    <a class="dropdown-item" href="systemanalysis.php">System Analysis and Design</a>
    <a class="dropdown-item" href="visualprogramming.php">Visual programming</a>
  <a class="dropdown-item" href="computerarchitecture.php">Computer Architecture</a>
  <a class="dropdown-item" href="computerrepair.php">Computer Repair & Maintenance</a>
  <a class="dropdown-item" href="computergraphics.php">Computer Graphics</a>
  <a class="dropdown-item" href="statistics.php">Statistics & Probability</a>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from engineering_resource where faculty='computer' and subject = 'Web Technology and Programming II' and semister = 'first' and year = 'second'";
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='computer' and subject = 'Web Technology and Programming II' and  semister = 'first' and year='second' ORDER BY id ASC LIMIT $start_from, $limit";
                      $query=mysqli_query($db,$sql);
