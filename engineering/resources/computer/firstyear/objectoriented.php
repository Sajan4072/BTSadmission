...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>COMPUTER ENGINEERING FIRST YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<h5 style="text-align: center;">WELCOME TO OBJECT ORIENTED PROGRAMMING IN C++</h5>
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="communicationnepali.php">Communication Nepali</a>
    <a class="dropdown-item" href="communicationenglish.php">Communication English</a>
    <a class="dropdown-item" href="mathematicsfirst.php">Engineering Mathematics I</a>
    <a class="dropdown-item" href="physicsfirst.php">Engineering Physics I</a>
    <a class="dropdown-item" href="chemistryfirst.php">Engineering Chemistry I</a>
    <a class="dropdown-item" href="fundaments.php">Computer Fundaments</a>
  <a class="dropdown-item" href="engineeringdrawingfirst.php">Engineering Drawing I</a>
  <a class="dropdown-item" href="cprogramming.php">Computer Programming In C</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="mathematicssecond.php">Engineering Mathematics II</a>
    <a class="dropdown-item" href="physicssecond.php">Engineering Physics II</a>
    <a class="dropdown-item" href="chemistrysecond.php">Engineering Chemistry II</a>
  <a class="dropdown-item" href="digitallogic.php">Digital Logic</a>
  <a class="dropdown-item" href="objectoriented.php">Object Oriented Programming in C++</a>
  <a class="dropdown-item" href="electricalengineering.php">Electrical Engineering</a>
  <a class="dropdown-item" href="webtechnology.php">Web Technology & Programming I</a>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from engineering_resource where faculty='computer' and subject = 'Object Oriented Programming in C++' and semister = 'second' and year = 'first'";
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='computer' and subject = 'Object Oriented Programming in C++' and  semister = 'second' and year='first' ORDER BY id ASC LIMIT $start_from, $limit";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='objectoriented.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='objectoriented.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='objectoriented.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
