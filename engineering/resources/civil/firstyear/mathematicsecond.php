...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>CIVIL ENGINEERING FIRST YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="mathematicfirst.php">Engineering Mathematics I</a>
  ...
  <a class="dropdown-item" href="drawingfirst.php">Engineering Drawing I</a>
  <a class="dropdown-item" href="workshopfirst.php">Workshop Practice I</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="mathematicsecond.php">Engineering Mathematics II</a>
  ...
  <a class="dropdown-item" href="drawingsecond.php">Engineering Drawing II</a>
  <a class="dropdown-item" href="workshopsecond.php">Workshop Practice II</a>
  <a class="dropdown-item" href="materials.php">Engineering Materials</a>
  <a class="dropdown-item" href="computerapplication.php">Computer Application</a>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from engineering_resource where faculty='civil' and subject = 'Engineering Mathematics II' and semister = 'second' and year = 'first'";
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='civil' and subject = 'Engineering Mathematics II' and  semister = 'first' and year='first' ORDER BY id ASC LIMIT $start_from, $limit";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='mathematicsecond.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='mathematicsecond.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='mathematicsecond.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
