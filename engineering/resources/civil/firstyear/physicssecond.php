...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from engineering_resource where faculty='civil' and subject = 'Engineering Physics II' and semister = 'second' and year = 'first'";
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='civil' and subject = 'Engineering Physics II' and  semister = 'first' and year='first' ORDER BY id ASC LIMIT $start_from, $limit";
                      $query=mysqli_query($db,$sql);
