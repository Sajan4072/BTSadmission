...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>CIVIL ENGINEERING SECOND YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="surveyingfirst.php">Surveying I</a>
    <a class="dropdown-item" href="mechanics.php">Applied Mechanics</a>
  <a class="dropdown-item" href="hydrolics.php">basic Hydrolics</a>
  <a class="dropdown-item" href="building.php">Building Construction</a>
   <a class="dropdown-item" href="constructiondrawing.php">Construction Drawing</a>
    <a class="dropdown-item" href="computerdrawing.php">Computer Aided Drawing</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="socialstudies.php">Social Studies</a>
    <a class="dropdown-item" href="management.php">Management</a>
    <a class="dropdown-item" href="surveyingsecond.php">Surveying II</a>
  <a class="dropdown-item" href="costing.php">Estimating And Costing I</a>
  <a class="dropdown-item" href="structure.php">Mechanics of Structure</a>
  <a class="dropdown-item" href="soilmechanics.php">Soil Meachnics</a>
  <a class="dropdown-item" href="watersupply.php">Water Supply Engineering</a>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from engineering_resource where faculty='civil' and subject = 'Engineering Mathematics III' and semister = 'second' and year = 'second'";
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='civil' and subject = 'Engineering Mathematics III' and  semister = 'second' and year='second' ORDER BY id ASC LIMIT $start_from, $limit";
                      $query=mysqli_query($db,$sql);
