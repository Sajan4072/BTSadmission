...
<div class="row" style="background-color: green; height: 40px; color: white;justify-content: center;">
 <h4>CIVIL ENGINEERING THIRD YEAR</h4>
</div>
<style>
ul#menu li {
  display:inline;
...
<h5 style="text-align: center;">WELCOME TO HIGHWAY ENGINEERING II</h5>
...
<div class="row" style="justify-content: left; margin-left: 25px;">
  ...
  <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="surveyingsecond.php">Surveying II</a>
    <a class="dropdown-item" href="costingsecond.php">Estimating And Costing II</a>
    <a class="dropdown-item" href="structuraldesign.php">Structural Design and Drawing</a>
  <a class="dropdown-item" href="highwayengineering.php">Highway Engineering I</a>
  <a class="dropdown-item" href="sanitaryengineering.php">Sanitary Engineering</a>
   <a class="dropdown-item" href="constructionmanagement.php">Construction Management</a>
    <a class="dropdown-item" href="project.php">Minor Project(Survey Camp)</a>
</div>
  </li>
  <li>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
     <a class="dropdown-item" href="enterprenurship.php">Enterprenurship Development</a>
    <a class="dropdown-item" href="highwayengineeringsecond.php">Highway Engineering II</a>
    <a class="dropdown-item" href="costingthird.php">Estimating And Costing III</a>
  <a class="dropdown-item" href="drainage.php">Irrigation and Drainage Engineering</a>
  <a class="dropdown-item" href="majorproject.php">Major Project</a>
  <hr>
  Elective
  <a class="dropdown-item" href="trialbridge.php">Trial Bridge</a>
  <a class="dropdown-item" href="hillroad.php">Hill Road</a>
  <a class="dropdown-item" href="hillirrigation.php">Hill Irrigation Engineering</a>
  <a class="dropdown-item" href="ruralroad.php">Rural/ Agricultural Road</a>
  <a class="dropdown-item" href="gravity.php">Gravity Flow Water <br>Supply System</a>
  ...
  <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; justify-content: center;">
    <div class="col">
         ...
         <div class="row">
           <?php          
                      $sql="select *from engineering_resource where faculty='civil' and subject = 'Highway Engineering II' and semister = 'second' and year = 'third'";
...
$start_from = ($page-1) * $limit;  
                      ...
                      $sql="select *from engineering_resource where faculty ='civil' and subject = 'Highway Engineering II' and  semister = 'second' and year='third' ORDER BY id ASC LIMIT $start_from, $limit";
                      $query=mysqli_query($db,$sql);
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='highwayengineeringsecond.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='highwayengineeringsecond.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='highwayengineeringsecond.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
