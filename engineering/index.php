          ...
          <form class="form-inline my-2 my-lg-0" style="margin-right: 35px;">
            <ul class="navbar-nav mr-5" >
              <li class="nav-item dropdown" >
                ...
                <a class="dropdown-item" href="login/teacher_login.php" style="background-color: white;">Teacher</a>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" data-interval="2000">
  <div class="carousel-inner">
    <div class="carousel-item active" >
      <img class="d-block w-100" src="frontpage/photos/oengineering3.jpg" alt="First slide">
    </div>

    <div class="carousel-item">
      <img class="d-block w-100" src="frontpage/photos/engineering.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
