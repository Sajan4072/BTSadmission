...
<html lang="en">
  ...
  <body>
    ...
    <div class="row justify-content-center" style="background-color: white;">
      ...
      <h3 style="text-align: center; color: #6AAC6F">Welcome <?php echo $_SESSION['teacher_user'];?></h3>
        <?php 
 $query = ("SELECT * FROM engineering_teacher WHERE firstname='" . $_SESSION["teacher_user"] ."'");
