...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="eng6.php">English</a>
    <a class="dropdown-item" href="math6.php">Math</a>
    <a class="dropdown-item" href="science6.php">Science</a>
    <a class="dropdown-item" href="social6.php">Social</a>
    <a class="dropdown-item" href="nepali6.php">Nepali</a>
    <a class="dropdown-item" href="grammar6.php">Grammar</a>
    <a class="dropdown-item" href="eph6.php">EPH</a>
    <a class="dropdown-item" href="computer6.php">Computer</a>
...
<div class="row" style="background-color: #FAE19D; height: 50px; color: black;justify-content: center; margin-top: 20px;">
 <h1>CLASS SIX COMPUTER RESOURCES</h1>
</div>
       <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; ">                      
          ...
          <?php          
                      ...
                      $sql="select *from school_resource where class = 6 and subject = 'Computer'";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='computer6.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
    ...
    <li class="page-item">
      <?php  
$result_db = mysqli_query($db,"SELECT COUNT(id) FROM school_resource where class = 6"); 
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='computer6.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='computer6.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
