...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="eng9.php">English</a>
    <a class="dropdown-item" href="math9.php">Math</a>
    <a class="dropdown-item" href="science9.php">Science</a>
    <a class="dropdown-item" href="social9.php">Social</a>
    <a class="dropdown-item" href="nepali9.php">Nepali</a>
    <a class="dropdown-item" href="eph9.php">EPH</a>
    <a class="dropdown-item" href="opt9.php">Optional Math</a>
    <a class="dropdown-item" href="computer9.php">Computer</a>
    <a class="dropdown-item" href="account9.php">Account</a>
...
<div class="row" style="background-color: #FAE19D; height: 50px; color: black;justify-content: center; margin-top: 20px;">
 <h1>CLASS NINE COMPUTER RESOURCES</h1>
</div>
       <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; ">                      
          ...
          <?php          
                      ...
                      $sql="select *from school_resource where class = 9 and subject = 'Computer'";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='computer9.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='computer9.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='computer9.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
