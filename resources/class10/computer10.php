...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="../class/eng5.php">English</a>
    <a class="dropdown-item" href="../class/math5.php">Math</a>
    <a class="dropdown-item" href="../class/science5.php">Science</a>
    <a class="dropdown-item" href="../class/social5.php">Social</a>
    <a class="dropdown-item" href="../class/nepali5.php">Nepali</a>
    <a class="dropdown-item" href="../class/grammar5.php">Grammar</a>
    <a class="dropdown-item" href="../class/eph5.php">EPH</a>
    <a class="dropdown-item" href="../class/computer5.php">Computer</a>
...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="../class/eng8.php">English</a>
    <a class="dropdown-item" href="../class/math8.php">Math</a>
    <a class="dropdown-item" href="../class/science8.php">Science</a>
    <a class="dropdown-item" href="../class/social8.php">Social</a>
    <a class="dropdown-item" href="../class/nepali8.php">Nepali</a>
    <a class="dropdown-item" href="../class/eph8.php">EPH</a>
    <a class="dropdown-item" href="../class/opt8.php">Optional Math</a>
    <a class="dropdown-item" href="../class/computer8.php">Computer</a>
    <a class="dropdown-item" href="../class/account8.php">Account</a>
...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="eng10.php">English</a>
    <a class="dropdown-item" href="math10.php">Math</a>
    <a class="dropdown-item" href="science10.php">Science</a>
    <a class="dropdown-item" href="social10.php">Social</a>
    <a class="dropdown-item" href="nepali10.php">Nepali</a>
    <a class="dropdown-item" href="eph10.php">EPH</a>
    <a class="dropdown-item" href="opt10.php">Optional Math</a>
    <a class="dropdown-item" href="computer10.php">Computer</a>
    <a class="dropdown-item" href="account10.php">Account</a>
    
  </div>
</div>
</div>
<div class="row" style="background-color: #FAE19D; height: 50px; color: black;justify-content: center; margin-top: 20px;">
 <h1>CLASS TEN COMPUTER  RESOURCES</h1>
</div>
                             
                      
          <?php          
                      $sql="select *from school_resource where class = 10 and subject = 'Computer'";
