...
<div class="row" style="background-color: #FAE19D; height: 50px; color: black;justify-content: center; margin-top: 20px;">
 <h1>CLASS EIGHT NEPALI RESOURCES</h1>
</div>
       <div class="row" style="background-color: #fae19d; padding: 20px; margin-top: 10px; ">                      
          ...
          <?php          
                      ...
                      $sql="select *from school_resource where class = 8 and subject = 'Nepali'";
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='nepali8.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?>
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='nepali8.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='nepali8.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
