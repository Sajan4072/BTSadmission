...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2020 at 09:23 AM
...
INSERT INTO `calender` (`id`, `event`, `date`, `school`, `plus2`, `engineering`, `created_at`) VALUES
(1, 'tihar', '0000-00-00', 1, 0, 1, NULL),
(2, 'holi', '0000-00-00', 0, 0, 0, NULL),
(3, 'chat', '2020-11-02', 1, 0, 0, NULL),
(4, 'fadfdhafd adfafdafdaf dfaoifhdafh', '2020-11-12', 1, 0, 1, NULL),
(5, 'gdagafag', '2020-12-04', 1, 0, 0, NULL),
(6, 'tihar', '2020-11-06', 1, 0, 0, NULL),
(7, 'dashain functional ', '2020-12-09', 1, 1, 0, NULL);
...
INSERT INTO `college` (`id`, `firstname`, `lastname`, `address`, `fathername`, `phone`, `image`, `faculty`, `uniquecode`, `password`, `dob`) VALUES
(1, 'rabin', 'bsan', 'bdiae', 'Gyan', '2147483647', '2.png', 'management', 'CLS9-9632', 'RABin14785', '2020-11-18'),
(2, 'rabin', 'bsasn', 'bode', 'gan', '2147483647', '2.png', 'management', 'CLS9-6325', 'RABin14785', '2020-11-18'),
(3, 's', 's', 's', 's', '2147483647', '2.png', 'computer', 'CLS9-6325', 'NJki14785', '2020-11-17'),
(4, 's', 's', 'd', 'a', '2147483647', '2.png', 'civil', 'CLS9-96325', 'HGij47851', '2020-11-16');
...
INSERT INTO `college_resource` (`id`, `pdf`, `image`, `subject`, `class`, `caption`, `management`) VALUES
(1, 'Sample_Entry.pdf', 'lab.jpg', 'physic', '11', 'sicnec', '0'),
(2, 'detail cloud computing bsc.pdf', 'engineering4.jpg', 'nepali', '11', 'asda', '0'),
(3, 'detail cloud computing bsc.pdf', 'engineering4.jpg', 'chemistry', '11', 'asdad', '0'),
(4, 'Sample_Entry.pdf', 'engineering1.jpg', 'biology', '11', 'asa', '0'),
(5, 'Sample_Entry.pdf', 'engineering2.jpg', 'english', '11', 'rtg', '0'),
(6, 'detail cloud computing bsc.pdf', 'lab.jpg', 'nepali', '11', 'asdas', '0'),
(7, 'JS CH3035 Electrochemistry 2013-2014 New Course L5', 'engineering4.jpg', 'nepali', '11', 'asdasd', '0'),
(8, 'rabinCV.pdf', 'engineering2.jpg', 'nepali', '11', 'ffd', '0'),
(9, 'detail cloud computing bsc.pdf', 'group.jpg', 'management', '11', 'asd', '1'),
(11, 'Rule for Time-bound_4107.pdf', 'rule.PNG', 'Accounting', '11', 'ok', '1');
...
INSERT INTO `college_teacher` (`id`, `firstname`, `lastname`, `address`, `phone`, `email`, `image`, `password`) VALUES
(1, 'ra', 'aa', 'aa', '2147483647', 'rabin11@gmail.com', '2.png', 'RAbin14785'),
(2, 'Jitu', 'Rai', 'Bhaktapur', '12343552', 'jit4@gmail.com', '', 'Jitu@123');
...
INSERT INTO `engineering` (`id`, `firstname`, `lastname`, `address`, `fathername`, `phone`, `uniquecode`, `password`, `image`, `faculty`, `dob`) VALUES
(1, 'rabin', 'bassan', 'bode', 'gyan', '2147483647', 'CLS10-21463', 'RAbin1478', '92516506_2556377781301493_159646111940739072_o.jpg', 'computer', '2020-11-25');
...
(9, 'rule.PNG', 'Rule for Time-bound_4107.pdf', 'first', 'first', 'Computer Programming In C', 'computer');
...
INSERT INTO `engineering_teacher` (`id`, `firstname`, `lastname`, `address`, `contact`, `email`, `image`, `password`) VALUES
(1, 'aad', 'dd', 'asd', '2147483647', 'as@gmail.com', '', 'ASdf147852');
...
(18, 'sarswati puja ', ' there will be a poja for sarswati tommorow\r\n\r\n             ', '2020-12-09', 0, 1, 1),
(19, 'sarswati puja 2', 'sarswati puja for school', '2020-12-01', 1, 0, 0);
...
INSERT INTO `notice` (`id`, `notice`, `school`, `plus2`, `engineering`, `created_at`) VALUES
(3, ' \r\nnotice 1\r\n             ', 1, 1, 1, '0000-00-00'),
(4, ' yeah\r\n\r\n             ', 1, 0, 1, '0000-00-00'),
(7, ' \r\nthere will be examination tomorrow\r\n             ', 1, 1, 1, '0000-00-00'),
(8, 'this is notice for everyone              ', 1, 1, 0, '0000-00-00'),
(9, 'helpp fadfad  dfadfd cdafafda fadfd a dfada', 1, 1, 1, '0000-00-00'),
(10, 'dsafadcd dfa dafdaf fadfad', 1, 1, 1, '0000-00-00'),
(11, 'rqereqwfc ef eqwe', 1, 1, 1, '0000-00-00'),
(12, 'fdasfda  dfas', 1, 1, 1, '0000-00-00');
...
INSERT INTO `school` (`id`, `firstname`, `lastname`, `address`, `fathername`, `contact`, `password`, `image`, `uniquecode`, `dob`) VALUES
(1, 'rabin', 'basan', 'bode,bkt', 'gyan', '2147483647', 'RAbin1478', '92516506_2556377781301493_159646111940739072_o.jpg', 'CLS9-1478', '2020-11-11'),
(2, 'a', 'd', 'a', 'a', '2147483647', 'SFRgs4785', '106260846_168440161354929_3013438027343079164_n.jpg', 'CLS9-8745', '2020-11-10'),
(3, 'a', 'a', 'a', 'a', '2147483647', 'GHJki14785', '2.png', 'CLS1-521463', '2020-11-16'),
(4, 'Sajan', 'Rai', 'Pepsicola', 'Messi Rai', '2147483647', 'RAbin1478', '', 'CLS10-1478', '2020-12-10'),
(5, 'Sajan', 'Rai', 'Kathmandu', 'Maradona', '12345678', 'Sajan123@', NULL, 'CLS8-123', '2020-12-03');
...
(4, 'Rule for Time-bound_4107.pdf', 'rule.PNG', 'English', 2, ''),
(5, 'Rule for Time-bound_4107.pdf', 'rule.PNG', 'English', 4, '');
...
INSERT INTO `school_teacher` (`id`, `firstname`, `lastname`, `phone`, `address`, `email`, `image`, `password`) VALUES
(1, 'radad', 'adsasd', '2147483647', 'asdas', 'rabin11@gmail.com', '2.png', 'RAbin1478');
...
INSERT INTO `user_message` (`id`, `name`, `phone`, `email`, `message`) VALUES
(1, 'rabin', 2147483647, 'rabinbasansth@gmail.com', 'dsasdadada'),
(2, 'rr', 2147483647, 'r@gmail.com', 'asdad'),
(3, 'rr', 2147483647, 'rabin@gmail.com', 'asdasd');
